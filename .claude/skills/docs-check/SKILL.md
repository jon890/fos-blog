...
fos-blog 도메인 지식 (ADR-001~025 / 핵심 5 docs / Drizzle schema / 레이어 규칙 / 홈서버 배포 가드 / docs/pages/ 7개) 이 박힌 custom agent `fos-blog-docs-verifier` (`.claude/agents/fos-blog-docs-verifier.md`) 에 위임:
