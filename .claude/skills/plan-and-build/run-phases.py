...
Usage:
  ...
  예: python .claude/skills/plan-and-build/run-phases.py tasks/v1-initial-setup
      python .claude/skills/plan-and-build/run-phases.py tasks/v1-initial-setup --from-phase 3
...
def load_dotenv() -> None:
    ...
    # .claude/skills/plan-and-build/ 기준으로 상위 4단계가 프로젝트 루트
