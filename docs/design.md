...
hue 195 고정, lightness·chroma 만 단계별 변형. dark/light 공통(중립 배경 대비로 동작).
...
| inline code | `--font-mono` · 0.88em · brand-400 색<br>subtle border + bg-subtle 배경<br>`word-break: keep-all`(한글/식별자 글자단위 분해 방지) |
