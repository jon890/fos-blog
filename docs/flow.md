...
**구현 범위:** 공통 관리자 로그인과 자료 저장·소스·수집 cursor·개인 상태·추천·게시·가져오기 API, 관리자 공부 화면 흐름을 제공한다.
...
관리자 메뉴의 세 항목은 각각 공부 자료, 추천 이력, 이력 가져오기 화면으로 이동하는 링크를 제공한다.
...
fos-blog는 추천 리포트와 외부 게시 결과만 저장하며 외부 채널에 직접 게시하지 않는다.
